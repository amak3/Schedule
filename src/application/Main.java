...
public class Main extends Application 
{
	...
	public void start(Stage stage) throws IOException 
	{
		...
		vbox.getChildren().addAll(labelForYear, filterFieldSubject, labelForLeader, filterFieldLeader, labelForSubject, buttonYear, labelForStudy, buttonStudy, labelForGroup,buttonGroup, labelForCalendar, calendar, root, table); 
		vbox.setSpacing(5);
...
//                  Object o = buttonStudy.getSelectionModel().getSelectedItem();
//         if (o != null)
//         System.out.println(buttonStudy.getClass());
